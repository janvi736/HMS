...
<a href="/hospital-management/api/appointments.php?action=delete&id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this appointment?')" style="color:red">Delete</a>
        </td>
      </tr>
      <?php endwhile; ?>
    </tbody>
